...
class Transform:
	...
	def toString(self):
		return str(("%f," % self.location[0]) + ("%f," % self.location[1]) + ("%f," % self.location[2])
				+ ("%f," % self.rotation[0]) + ("%f," % self.rotation[1]) + ("%f," % self.rotation[2])
				+ ("%f," % self.scale[0]) + ("%f," % self.scale[1]) + ("%f" % self.scale[2]))
...
class Color:
	...
	def toString(self):
		return str(("%f," % self.red) + ("%f," % self.green) + ("%f," % self.blue) + ("%f" % self.alpha))
...
class Vertex:
	...
	def toString(self):
		return str(("%f," % self.location[0]) + ("%f," % self.location[1]) + ("%f," % self.location[2])
					+ ("%f," % self.normal[0]) + ("%f," % self.normal[1]) + ("%f," % self.normal[2])
					+ ("%i" % self.material))
...
class Face:
	...
	def toString(self):
		return str(("%i," % self.vertices[0]) + ("%i," % self.vertices[1]) + ("%i," % self.vertices[2])
					+ ("%f," % self.normal[0]) + ("%f," % self.normal[1]) + ("%f," % self.normal[2])
					+ ("%f," % self.uv1[0]) + ("%f," % self.uv1[1])
					+ ("%f," % self.uv2[0]) + ("%f," % self.uv2[1])
					+ ("%f," % self.uv3[0]) + ("%f," % self.uv3[1])
					+ ("%i" % self.material))
