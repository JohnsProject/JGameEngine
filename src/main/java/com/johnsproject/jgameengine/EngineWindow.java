...
public class EngineWindow extends EngineObject {

	private EngineFrame frame;
	
	public EngineWindow(FrameBuffer frameBuffer) {
		frame = new EngineFrame(frameBuffer);
	...
	private class EngineFrame extends Frame {
		...
		public EngineFrame(FrameBuffer frameBuffer) {
