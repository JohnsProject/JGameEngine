...
public class LinearRasterizer4 extends LinearRasterizer2 {
	...
	protected int splitTriangle() {
        ...
        vector23[VECTOR_X] = vector20[VECTOR_X] + FixedPoint.multiply(dy, vector22[VECTOR_X] - vector20[VECTOR_X]);
        vector23[VECTOR_Y] = vector20[VECTOR_Y] + FixedPoint.multiply(dy, vector22[VECTOR_Y] - vector20[VECTOR_Y]);
        vector23[VECTOR_Z] = vector20[VECTOR_Z] + FixedPoint.multiply(dy, vector22[VECTOR_Z] - vector20[VECTOR_Z]);
        vector33[VECTOR_X] = vector30[VECTOR_X] + FixedPoint.multiply(dy, vector32[VECTOR_X] - vector30[VECTOR_X]);
        vector33[VECTOR_Y] = vector30[VECTOR_Y] + FixedPoint.multiply(dy, vector32[VECTOR_Y] - vector30[VECTOR_Y]);
        vector33[VECTOR_Z] = vector30[VECTOR_Z] + FixedPoint.multiply(dy, vector32[VECTOR_Z] - vector30[VECTOR_Z]);
        return dy;
	}
	...
	protected void initializeBottomTriangle() {
		...
		dv2x1 = FixedPoint.multiply(vector21[VECTOR_X] - vector20[VECTOR_X], y2y1Shifted);
		dv2x2 = FixedPoint.multiply(vector22[VECTOR_X] - vector20[VECTOR_X], y3y1Shifted);
		dv2y1 = FixedPoint.multiply(vector21[VECTOR_Y] - vector20[VECTOR_Y], y2y1Shifted);
		dv2y2 = FixedPoint.multiply(vector22[VECTOR_Y] - vector20[VECTOR_Y], y3y1Shifted);
		dv2z1 = FixedPoint.multiply(vector21[VECTOR_Z] - vector20[VECTOR_Z], y2y1Shifted);
		dv2z2 = FixedPoint.multiply(vector22[VECTOR_Z] - vector20[VECTOR_Z], y3y1Shifted);
		dv3x1 = FixedPoint.multiply(vector31[VECTOR_X] - vector30[VECTOR_X], y2y1Shifted);
		dv3x2 = FixedPoint.multiply(vector32[VECTOR_X] - vector30[VECTOR_X], y3y1Shifted);
		dv3y1 = FixedPoint.multiply(vector31[VECTOR_Y] - vector30[VECTOR_Y], y2y1Shifted);
		dv3y2 = FixedPoint.multiply(vector32[VECTOR_Y] - vector30[VECTOR_Y], y3y1Shifted);
		dv3z1 = FixedPoint.multiply(vector31[VECTOR_Z] - vector30[VECTOR_Z], y2y1Shifted);
		dv3z2 = FixedPoint.multiply(vector32[VECTOR_Z] - vector30[VECTOR_Z], y3y1Shifted);
	...
	protected void initializeTopTriangle() {
		...
		dv2x1 = FixedPoint.multiply(vector22[VECTOR_X] - vector20[VECTOR_X], y3y1Shifted);
		dv2x2 = FixedPoint.multiply(vector22[VECTOR_X] - vector21[VECTOR_X], y3y2Shifted);
		dv2y1 = FixedPoint.multiply(vector22[VECTOR_Y] - vector20[VECTOR_Y], y3y1Shifted);
		dv2y2 = FixedPoint.multiply(vector22[VECTOR_Y] - vector21[VECTOR_Y], y3y2Shifted);
		dv2z1 = FixedPoint.multiply(vector22[VECTOR_Z] - vector20[VECTOR_Z], y3y1Shifted);
		dv2z2 = FixedPoint.multiply(vector22[VECTOR_Z] - vector21[VECTOR_Z], y3y2Shifted);
		dv3x1 = FixedPoint.multiply(vector32[VECTOR_X] - vector30[VECTOR_X], y3y1Shifted);
		dv3x2 = FixedPoint.multiply(vector32[VECTOR_X] - vector31[VECTOR_X], y3y2Shifted);
		dv3y1 = FixedPoint.multiply(vector32[VECTOR_Y] - vector30[VECTOR_Y], y3y1Shifted);
		dv3y2 = FixedPoint.multiply(vector32[VECTOR_Y] - vector31[VECTOR_Y], y3y2Shifted);
		dv3z1 = FixedPoint.multiply(vector32[VECTOR_Z] - vector30[VECTOR_Z], y3y1Shifted);
		dv3z2 = FixedPoint.multiply(vector32[VECTOR_Z] - vector31[VECTOR_Z], y3y2Shifted);
	...
	protected void initializeDx1GreaterDx2() {
		...
		dv2x = FixedPoint.multiply(dv2x1 - dv2x2, dxdx);
    	dv2y = FixedPoint.multiply(dv2y1 - dv2y2, dxdx);
    	dv2z = FixedPoint.multiply(dv2z1 - dv2z2, dxdx);
    	dv3x = FixedPoint.multiply(dv3x1 - dv3x2, dxdx);
    	dv3y = FixedPoint.multiply(dv3y1 - dv3y2, dxdx);
    	dv3z = FixedPoint.multiply(dv3z1 - dv3z2, dxdx);
	}

	@Override
	protected void initializeDx2GreaterDx1() {
		super.initializeDx2GreaterDx1();
		dv2x = FixedPoint.multiply(dv2x2 - dv2x1, dxdx);
    	dv2y = FixedPoint.multiply(dv2y2 - dv2y1, dxdx);
    	dv2z = FixedPoint.multiply(dv2z2 - dv2z1, dxdx);
    	dv3x = FixedPoint.multiply(dv3x2 - dv3x1, dxdx);
    	dv3y = FixedPoint.multiply(dv3y2 - dv3y1, dxdx);
    	dv3z = FixedPoint.multiply(dv3z2 - dv3z1, dxdx);
	}
